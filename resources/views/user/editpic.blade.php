        ...
        <div class="fly-panel fly-panel-user" pad20>
            <div class="layui-tab layui-tab-brief" lay-filter="user">
                <ul class="layui-tab-title" id="LAY_mine">
                    ...
                    <a href="/user/setfile/editpic"><li class="layui-this">图片管理</li></a>
        ...
        layui.use(['flow','form','layer','upload'],function(){
            ...
            flow.load({
                elem: '#Images', //流加载容器
                    ...
                    $.get("/user/piclists",function(res){
                        //模拟插入
                        var imgList = [],data = res.data;
                        var maxPage = imgNums*page < data.length ? imgNums*page : data.length;
                        setTimeout(function(){
                            for(var i=imgNums*(page-1); i<maxPage; i++){
                                imgList.push('<li class="photos"><img layer-src="'+ data[i].path +'" src="'+ data[i].path +'" alt="'+data[i].id+'">' +
                                    '<div class="operate"><div class="check"><input type="checkbox" name="belle" lay-filter="choose" lay-skin="primary" title="'+data[i].id+'">' +
