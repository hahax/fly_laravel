...
@if(Session::has('myflash.message'))
    <div class="myflash-notification" style=" z-index: 2015;">
        ...
        <div class="notification__group is-with-icon"><h2 class="notification__title">提示</h2>
    ...
    <script>
        $('.myflash-notification').animate({opacity:1}).fadeIn('fast').delay(3000).fadeOut(500);
